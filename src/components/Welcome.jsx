...
const Welcome = () => {
  ...
  return (
    <section id="welcome">
        <p ref={subtitleRef}>{renderText("Hey, I'am Vedang! Welcome to my",
        ...
        <div className="small-screen">
            <p>This portfolio is designed for desktop/tablet screens only  , <a href="https://vedangsportfolio.netlify.app/">For small screen- Click here</a></p>
